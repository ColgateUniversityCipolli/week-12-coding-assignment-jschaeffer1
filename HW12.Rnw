...
t values that satisfy $\abs{t}>1.729$ provide statistically discernible support.

  \item What values of $t_{30}$ provide statistically discernible support for the
  alternative hypothesis?
  
  t values that satisfy $\abs{t}>1.699$ provide statistically discernible support.
